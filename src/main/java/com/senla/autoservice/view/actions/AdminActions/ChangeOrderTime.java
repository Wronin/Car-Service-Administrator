...
public class ChangeOrderTime implements IAction {
    private final AdminController adminController;

    public ChangeOrderTime(ApplicationContext applicationContext) throws ReflectiveOperationException {
    ...
    public void execute() {
        ...
        adminController.changeOrderTime(scanner.nextInt());
    }
}
